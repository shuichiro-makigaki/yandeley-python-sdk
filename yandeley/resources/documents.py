...
from yandeley.models.documents import *
from yandeley.resources.base import add_query_params, ListResource
...
class Documents(DocumentsBase):
    ...
    - documents for the logged-in user, if retrieved from a
      :func:`MendeleySession <yandeley.session.MendeleySession.documents>`.
    - documents in a :func:`Group <yandeley.models.groups.Group.documents>`.
    """
    _url = '/documents'
    ...
    def get(self, id, view=None):
        ...
        :return: a :class:`UserDocument <yandeley.models.documents.UserDocument>`.
        """
    ...
    def list(self, page_size=None, view=None, sort=None, order=None, modified_since=None, deleted_since=None):
        ...
        :return: a :class:`Page <yandeley.pagination.Page>` of
                 :class:`UserDocuments <yandeley.models.documents.UserDocument>`.
        """
    ...
    def iter(self, page_size=None, view=None, sort=None, order=None, modified_since=None, deleted_since=None):
        ...
        :param modified_since: if specified, only returns files modified after this timestamp.
        :param deleted_since: if specified, only returns the IDs of documents deleted after this timestamp.
        :return: an iterator of :class:`UserDocuments <yandeley.models.documents.UserDocument>`.
        """
    ...
    def create(self, title, type, **kwargs):
        ...
        :param kwargs: other properties of the document.  These can be any of the attributes on
               :class:`UserDocument <yandeley.models.documents.UserDocument>` or any of its views.
        :return: a :class:`UserDocument <yandeley.models.documents.UserDocument>`.
        """
        kwargs['title'] = title
        kwargs['type'] = type
    ...
    def search(self, query, view=None):
        ...
        :param view: the view to get.  One of 'bib', 'client', 'tags', 'all'.
        :return: a :class:`DocumentsSearch <yandeley.resources.documents.DocumentsSearch>` resource, from which results
                 can be retrieved.
        """
        if self.group_id:
...
class DocumentsSearch(ListResource):
    ...
    def list(self, page_size=None):
        ...
        :return: a :class:`Page <yandeley.pagination.Page>` of
                 :class:`CatalogDocuments <yandeley.models.catalog.CatalogDocument>`.
        """
    ...
    def iter(self, page_size=None):
        ...
        :return: an iterator of :class:`CatalogDocuments <yandeley.models.catalog.CatalogDocument>`.
        """
