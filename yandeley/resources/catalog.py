...
from yandeley.models.catalog import *
from yandeley.resources.base import add_query_params, ListResource, GetByIdResource
...
class Catalog(GetByIdResource):
    ...
    def get(self, id, view=None):
        ...
        :return: a :class:`CatalogDocument <yandeley.models.catalog.CatalogDocument>`.
        """
    ...
    def search(self, query, view=None):
        ...
        :param view: the view to get.  One of 'bib', 'client', 'stats', 'all'.
        :return: a :class:`CatalogSearch <yandeley.resources.catalog.CatalogSearch>` resource, from which results can be
                 retrieved.
        """
