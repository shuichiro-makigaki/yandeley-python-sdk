...
class Page(object):
    ...
    def first_page(self):
        """
        the first :class:`Page <yandeley.pagination.Page>` of the collection.
        """
    ...
    def next_page(self):
        """
        the next :class:`Page <yandeley.pagination.Page>` of the collection, or `None` if this is the last page.
        """
        return self._navigate('next')
    ...
    def previous_page(self):
        """
        the previous :class:`Page <yandeley.pagination.Page>` of the collection, or `None` if this is the first page.
        """
