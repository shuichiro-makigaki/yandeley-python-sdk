...
from yandeley.models.common import Photo
from yandeley.models.profiles import Profile
from yandeley.response import SessionResponseObject, LazyResponseObject
...
class Group(SessionResponseObject):
    ...
    def photo(self):
        """
        a :class:`Photo <yandeley.models.common.Photo>`.
        """
    ...
    def documents(self):
        """
        a :class:`Documents <yandeley.resources.documents.Documents>` resource, from which
        :class:`UserDocuments <yandeley.models.documents.UserDocument>` can be retrieved.
        """
    ...
    def trash(self):
        """
        a :class:`Trash <yandeley.resources.trash.Trash>` resource, from which
        :class:`TrashDocuments <yandeley.models.documents.TrashDocument>` can be retrieved.
        """
