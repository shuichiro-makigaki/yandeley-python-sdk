...
from yandeley.models.base_documents import BaseDocument, BaseBibView, BaseClientView
...
class UserBaseDocument(BaseDocument):
    ...
    def profile(self):
        """
        a :class:`Profile <yandeley.models.profiles.Profile>`.
        """
    ...
    def group(self):
        """
        a :class:`Group <yandeley.models.groups.Group>`.
        """
    ...
    def files(self):
        """
        a :class:`Files <yandeley.resources.files.Files>` resource, from which
        :class:`Files <yandeley.models.files.File>` can be retrieved.
        """
...
class UserBibView(BaseBibView):
    """
    Additional fields returned when getting a :class:`UserDocument <yandeley.models.documents.UserDocument>` or
    :class:`TrashDocument <yandeley.models.documents.TrashDocument>` with view='bib' or 'all'.
...
class UserClientView(BaseClientView):
    """
    Additional fields returned when getting a :class:`UserDocument <yandeley.models.documents.UserDocument>` or
    :class:`TrashDocument <yandeley.models.documents.TrashDocument>` with view='client' or 'all'.
...
class UserTagsView(object):
    """
    Additional fields returned when getting a :class:`UserDocument <yandeley.models.documents.UserDocument>` or
    :class:`TrashDocument <yandeley.models.documents.TrashDocument>` with view='tags' or 'all'.
...
class UserDocument(UserBaseDocument):
    ...
    def attach_file(self, path):
        ...
        :return: a :class:`File <yandeley.models.files.File>`.
        """
