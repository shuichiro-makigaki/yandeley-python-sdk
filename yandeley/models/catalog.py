from yandeley.models.base_documents import BaseDocument, BaseClientView, BaseBibView
from yandeley.response import LazyResponseObject
...
class CatalogBibView(BaseBibView):
    """
    Additional fields returned when getting a :class:`CatalogDocument <yandeley.models.catalog.CatalogDocument>` with
    view='bib' or 'all'.
